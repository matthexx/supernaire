                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    ...
                                    <span class="desc">Cooporative System</span>
                                    <div class="icon">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    ...
                                    <span class="desc">Networking System</span>
                                    <div class="icon">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item">
                                <h2 class="number">10,368</h2>
                                <span class="desc">Investment Plan</span>
                                <div class="icon">
                                    <i class="zmdi zmdi-account-o"></i>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item">
                                <h2 class="number">388,688</h2>
                                <span class="desc">Educationaal Plan</span>
                                <div class="icon">
                                    <i class="zmdi zmdi-shopping-cart"></i>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item">
                                <h2 class="number">1,086</h2>
                                <span class="desc">Business Plan</span>
                                <div class="icon">
                                    <i class="zmdi zmdi-calendar-note"></i>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item">
                                <h2 class="number">$1,060,386</h2>
                                <span class="desc">Retirement Plan</span>
                                <div class="icon">
                                    <i class="zmdi zmdi-money"></i>
                                </div>
                            </div>
